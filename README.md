**NOTE: this check has moved to the datadog core integrations [repo](https://github.com/DataDog/integrations-core/tree/master/supervisord) and is installed with the agent**
